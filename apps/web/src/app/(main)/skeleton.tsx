...
export default function CharacterPageSkeleton() {
  return (
     <div className='w-full md:w-1/2'>
      <Card className='relative mt-10 w-full max-w-sm animate-pulse border-2 border-[#42b1cc] bg-gradient-to-br from-[#0d5759]/90 via-[#165c5f]/80 to-[#1a4d4f]/90 shadow-[0_0_20px_rgba(66,177,204,0.6),inset_0_0_60px_rgba(66,177,204,0.2),inset_0_0_100px_rgba(66,177,204,0.1)] backdrop-blur-sm'>
